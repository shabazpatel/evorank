...
PIPELINE = {
    "models": [
        {"family": "xgb", "objective": "rank:ndcg",
         "params": {"eta": 0.1298, "max_depth": 9, "min_child_weight": 0.174,
                    "subsample": 0.884, "colsample_bytree": 0.644,
                    "lambda": 4.22, "num_boost_round": 220}},
        {"family": "lgbm", "objective": "lambdarank",
         "params": {"learning_rate": 0.08, "num_leaves": 255,
                    "min_child_samples": 20, "n_estimators": 300,
                    "subsample": 0.85, "colsample_bytree": 0.8}},
    ],
    "ensemble": {"type": "zscore_weighted", "weights": [0.6, 0.4]},
}