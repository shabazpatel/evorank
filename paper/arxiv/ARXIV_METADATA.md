...
**Comments**
8 pages, 4 figures, 2 tables. Accepted at GenAIECommerce 2026, the Third Workshop on Agentic and Generative AI for E-commerce, co-located with RecSys 2026 (Minneapolis, MN, USA, September 28, 2026). To appear in CEUR Workshop Proceedings. Code and all machine-generated results: https://github.com/shabazpatel/evorank
...
**License**
CC BY 4.0 (matches the CEUR copyright clause in the paper; required by CEUR-WS)

**Journal reference / DOI**
Leave blank at submission; add "CEUR Workshop Proceedings, Vol. XXXX, 2026" and the URL once the volume is online.
...
- Author list and ORCIDs match the CEUR camera-ready; link ORCIDs in the arXiv author fields.
