...
earned each change; Figure~\ref{fig:feedback} shows it verbatim, exactly as
it appears in the next prompt.
...
the reporting standard. The result is not specific to the search algorithm: a
...
governing outcomes. Guidance (prompt knowledge, evidence-rich feedback)
