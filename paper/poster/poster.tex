...
\SectionHead{One loop, gated and audited}
...
%% ---------------- column 2 ----------------
\begin{minipage}[t]{0.315\textwidth}
\SectionHead{Campaign 1: the loop selects noise}
...
\SectionHead{Campaign 2: aim where there is headroom}
...
\SectionHead{Continual improvement, then proof}
...
\SectionHead{Metrics after selection}
