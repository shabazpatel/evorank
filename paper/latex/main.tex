...
island adapts its exploration intensity accordingly. The database keeps a Pareto archive over the three objectives (ndcg,
booking ndcg, pooled dollar-weighted revenue), with a scalar key used only
for tie-breaking. On stagnation the controller can prompt the LLM for a
