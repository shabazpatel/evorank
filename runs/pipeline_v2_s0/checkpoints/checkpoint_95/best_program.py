...
def build_features(df, stats):
    ...
    a competitive-pricing signal (mean comp*_rate) + stacked_score. Kept
    small (~15 cols) since kitchen-sink sets underperform this focused
    combination on this fold."""
    import numpy as np
    import pandas as pd
    out = {}
...
PIPELINE = {
    ...
    "models": [
        ...
        # validated to beat the ridge-diversity variant on this fold across
        # ndcg, book_ndcg, and (near-tied) revenue.
